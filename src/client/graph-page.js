...
// Graph page client: renders the global tag graph with pan/zoom, hover highlight, dragging, and layout/camera reset.
(function () {
  ...
  function renderGlobalGraph() {
    ...
    fetch('/graph.json?v=' + ts)
      ...
      .then(graph => {
        ...
        // Fallback for any remaining nodes: place on outer ring
        ...
        // Keep pristine positions for layout reset
  ...
  if (document.readyState === 'loading') {
    ...
    // If loaded dynamically after DOMContentLoaded, run immediately
    renderGlobalGraph();
  }
})();
